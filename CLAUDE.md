...
**Current Version:** v11.5.3 - PATCH release: Claude Code hooks config resolution under Marketplace install (#155, #156), graph orphan-prune `has_entity` fix (#150, #151, @filhocf), belief-derivation session-legacy noise filter (#121, #152, @filhocf); see [CHANGELOG.md](CHANGELOG.md) for details. (Issue/PR numbers refer to Codeberg.)
