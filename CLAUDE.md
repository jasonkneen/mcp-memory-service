...
**Current Version:** v10.73.0 - §6 Belief-Aware Quarantine pipeline (PR #36, @filhocf), §3 Consolidation Engine v2 / memory_distill (PR #39, @filhocf), §4+§5 Bootstrap Profile + Session Legacy (PR #40, @filhocf), §9 config refactor into 12 domain modules (PR #38, @filhocf) — ~1,828 tests — see [CHANGELOG.md](CHANGELOG.md) for details
