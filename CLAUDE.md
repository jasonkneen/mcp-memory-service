...
**Current Version:** v11.3.3 - PATCH release: fix(cli): memory CLI commands respect MCP_HTTPS_ENABLED (fixes silent failures when TLS is enabled) — see [CHANGELOG.md](CHANGELOG.md) for details
