...
**Current Version:** v10.17.2 - CI stability fixes (uv CLI test timeout 60s→120s, CI job timeout 10→20min, root install.py test skip guard) - see [CHANGELOG.md](CHANGELOG.md) for details
