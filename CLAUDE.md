...
**Current Version:** v10.72.0 - Milvus ranked-search parity (PR #32, @henry201605), Schema Versioning migration registry + CLI (RFC-1047 §6, PR #13, @filhocf), §2 Belief Store observation-to-belief derivation pipeline (RFC-1047 §2, PR #33, @filhocf) — ~1,828 tests — see [CHANGELOG.md](CHANGELOG.md) for details
