...
**Current Version:** v11.3.1 - PATCH release: claude-hooks noise reduction (auto-capture Stop event + isSessionMeaningful gate) — see [CHANGELOG.md](CHANGELOG.md) for details
