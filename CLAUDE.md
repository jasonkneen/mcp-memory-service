...
**Current Version:** v11.3.2 - PATCH release: declare numpy>=1.24.0 as core dependency (fixes uvx bare install crash, closes #98) — see [CHANGELOG.md](CHANGELOG.md) for details
