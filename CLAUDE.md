...
**Current Version:** v11.2.0 - MINOR release: OAuth security hardening (#91), sqlite-vec rowid collision fix (#90), composite graph scoring (#55/#77, @filhocf), OpenCode XDG state dir fix (#84) — ~2,539 tests — see [CHANGELOG.md](CHANGELOG.md) for details
