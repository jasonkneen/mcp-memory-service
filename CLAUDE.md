...
**Current Version:** v10.17.10 - Security: resolve 17 remaining CodeQL alerts (clear-text logging x5, log-injection x4, stack-trace-exposure x3, tarslip x1, polynomial-ReDoS x1, url-redirection x3) - see [CHANGELOG.md](CHANGELOG.md) for details
