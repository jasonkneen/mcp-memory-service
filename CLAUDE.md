...
**Current Version:** v10.20.0 - Streamable HTTP transport with OAuth 2.1 + PKCE for Claude.ai remote MCP connectivity (`--streamable-http`, PKCE S256, RFC 9728, #518) - see [CHANGELOG.md](CHANGELOG.md) for details
